          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">New Apple iPhone 13 Pro (256 GB) - Alpine Green.</p>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">AirPods Hi-Cubby 3rd Generation Speaker,Blue.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Lenovo Flex 5 14" Full HD 2-in-1 Touchscreen Laptop, 16GB RAM, 512GB SSD.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Nokia T20 Android Tablet , 4GB RAM + 64GB ROM, Android 11-Black.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">32" Samsung Odyssey QLED Curved Gaming Monitor 1MS 240Hz - LC32G75TQSMXZN.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Apple Iphone X With Facetime - 256 GB, 4G LTE, Black, 3 GB Ram, Single Sim.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Sony MDRZX110APBLACK Wired Headphones - Black.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">TOSHIBA Full Automatic Washing machine inverter 8KG Silver.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Prifix Air Cooler- Double -ice tank -70 Liters color white.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
          ...
          <div class="col-md-3 py-3 py-md-0">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="text-center">Silver+Decker 28L Microwave Oven with Grill - MZ2800PG-B5.</p>
                <div class="star text-center">
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
                  <i class="fa-solid fa-star checked"></i>
